...
//#define SCAN_FREQ     65 	// Panel Scan clock frequency, unit: 65MHz	  	//天马lcd时钟扫描频率


#define DRAM_FREQ    160  	// SDRAM clock frequency, unti: MHz	                                    mclk
#define CORE_FREQ    120  	// Core (system) clock frequency, unit: MHz                             cclk
u16 SCAN_FREQ = 31; 	// Panel Scan clock frequency, unit: 65MHz	  	//lcd时钟扫描频率       sclk

u32 stm_time_test=10;


//=====[05h] b3-b1=====//
//#define SCAN_DIVK1      // 000	   
#define SCAN_DIVK2	  // 001   原设置
...
void R5421_PLL_Initial(void);
void R5421_SDRAM_initail(void);
...
//	PDATA_Set_BGR();
		...
		if(TIMING_SET[10] !=0 )	{	HSYNC_High_Active();	}
		else	{	HSYNC_Low_Active();	}
		if(TIMING_SET[11] !=0 )	{	VSYNC_High_Active();	}
		else	{	VSYNC_Low_Active();	}
		if(TIMING_SET[12] !=0 )	{	DE_High_Active();	}
		else	{	DE_Low_Active();	}
//	HSYNC_Low_Active();		  
////    HSYNC_High_Active();
//	VSYNC_Low_Active();		
...
////    DE_Low_Active();
        ...
        LCD_HorizontalWidth_VerticalHeight(TIMING_SET[1],TIMING_SET[2]);	//天马1024x768
        LCD_Horizontal_Non_Display(TIMING_SET[3]);	//天马1024x768160
        LCD_HSYNC_Start_Position(TIMING_SET[4]);	//天马1024x76816~216
        LCD_HSYNC_Pulse_Width(TIMING_SET[7]);		//天马1024x7681~140
        LCD_Vertical_Non_Display(TIMING_SET[5]);	//天马1024x76823
        LCD_VSYNC_Start_Position(TIMING_SET[6]);	//天马1024x7681~49
        LCD_VSYNC_Pulse_Width(TIMING_SET[8]);		//天马1024x7681~20
...
//	Main_Image_Width(1100);	
//    
//	Main_Window_Start_XY(0,0);	
//	Canvas_Image_Start_address(0);
//	Canvas_image_width(1100);//

//	Active_Window_XY(0,0);
//	Active_Window_WH(TIMING_SET[1],TIMING_SET[2]);
//    delay_ms(10);
//    
//    
//    Memory_24bpp_Mode();
...
//        LCD_HorizontalWidth_VerticalHeight(TIMING_SET[1],TIMING_SET[2]);	//天马1024x768
//        LCD_Horizontal_Non_Display(TIMING_SET[3]);	//天马1024x768160     HBP
//        LCD_HSYNC_Start_Position(TIMING_SET[4]);	//天马1024x76816~216  HFP
//        LCD_HSYNC_Pulse_Width(TIMING_SET[7]);		//天马1024x7681~140  HPW
//        LCD_Vertical_Non_Display(TIMING_SET[5]);	//天马1024x76823     VBP
//        LCD_VSYNC_Start_Position(TIMING_SET[6]);	//天马1024x7681~49   VFP
//        LCD_VSYNC_Pulse_Width(TIMING_SET[8]);		//天马1024x7681~20   VPW
       
       LCD_HorizontalWidth_VerticalHeight(TIMING_SET[1],TIMING_SET[2]);	//天马1024x768
        LCD_Horizontal_Non_Display(TIMING_SET[3]);	//天马1024x768160     HBP
        LCD_HSYNC_Start_Position(TIMING_SET[4]);	//天马1024x76816~216  HFP
        LCD_HSYNC_Pulse_Width(TIMING_SET[7]);		//天马1024x7681~140  HPW
        LCD_Vertical_Non_Display(TIMING_SET[5]-1);	//天马1024x76823     VBP
        LCD_VSYNC_Start_Position(TIMING_SET[6]-1);	//天马1024x7681~49   VFP
        LCD_VSYNC_Pulse_Width(TIMING_SET[8]-1);		//天马1024x7681~20   VPW
        
//    if((TIMING_SET[1] == 750)&&(TIMING_SET[2] == 1334))
//    {
//        LCD_HorizontalWidth_VerticalHeight(TIMING_SET[1],TIMING_SET[2]);	//
//        LCD_Horizontal_Non_Display(248);	//??1024x768?160?   20    40    HBP
//        LCD_HSYNC_Start_Position(47);	//??1024x768?16~216?  27   47   HFP
//        LCD_HSYNC_Pulse_Width(8);		//??1024x768?1~140?   4        HPW
//        LCD_Vertical_Non_Display(22);	//??1024x768?23?      25       VBP
//        LCD_VSYNC_Start_Position(250);	//??1024x768?1~49?    252      VFP
//        LCD_VSYNC_Pulse_Width(4);		//??1024x768?1~20?     4       VPW 
//    }
...
//SCAN_FREQ = (Fram_range*(HBP+HFP+HDP+HPW)*(VBP+VFP+VDP+VPW))/1000000;
SCAN_FREQ = (TIMING_SET[0]*(TIMING_SET[3]+TIMING_SET[4]+TIMING_SET[1]+TIMING_SET[7])*(TIMING_SET[5]+TIMING_SET[6]+TIMING_SET[2]+TIMING_SET[8]))/1000000;
//plldivn_sclk = ((SCAN_FREQ * plldivk_sclkpow) / OSC_FREQ) - 1;     //----ADD  --NO USE
...
temp_cclk = (plldivk_cclk << 1) | plldivm_cclk; 
	...
	LCD_CmdWrite(0x07);
	LCD_DataWrite(temp_mclk);       delay_ms(1);	//单PLL铆﹚
	LCD_CmdWrite(0x09);
	LCD_DataWrite(temp_cclk);       delay_ms(1);	//单PLL铆﹚

	LCD_CmdWrite(0x06);
	LCD_DataWrite(plldivn_sclk);        delay_ms(1);	//单PLL铆﹚
	LCD_CmdWrite(0x08);
	LCD_DataWrite(plldivn_mclk);        delay_ms(1);	//单PLL铆﹚
	LCD_CmdWrite(0x0a);
	LCD_DataWrite(plldivn_cclk);        delay_ms(1);	//单PLL铆﹚
...
void R5421_SW_Reset(void)//IC Resetぃ穦睲Register/Memory
{
	unsigned char temp;
...
/*  0: PLL disable; allow change PLL parameter.
    ...
    delay_us(1);//PLL 币笆丁ぶ 1 us
}
void R5421_Sleep(void)
{
/*  0: Normal mode.
    1: Sleep mode.*/
	unsigned char temp;
...
{
	LCD_CmdWrite(0x76);
	LCD_DataWrite(0x80);//B1000_XXXX    circle
...
{
	LCD_CmdWrite(0x76);
	LCD_DataWrite(0xC0);//B1100_XXXX    circle
...
//[E5h]~[E6h]=========================================================================
void R5421_I2CM_Clock_Prescale(unsigned short WX)
{
/*
...
//[E7h]=========================================================================
void R5421_I2CM_Transmit_Data(unsigned char temp)
{
/*
...
//[E8h]=========================================================================
unsigned char R5421_I2CM_Receiver_Data(void)
{
/*
...
void R5421_I2CM_Read_With_Ack(void)
{
...
void R5421_I2CM_Read_With_Nack(void)
{
...
void R5421_I2CM_Write_With_Start(void)
{
 LCD_CmdWrite(0xE9);
#ifdef Disable_I2CM_Noise_Filter 
 LCD_DataWrite(0x90);
...
/*
 ...
 1=Nack
*/
unsigned char R5421_I2CM_Check_Slave_ACK(void)
{ 
unsigned char temp;
/*[bit7]
...
/*
 ...
 1=Busy
*/
unsigned char R5421_I2CM_Bus_Busy(void)
{
 unsigned char temp; 
...
/*
 ...
 1=Transferring
*/
unsigned char R5421_I2CM_transmit_Progress(void)
{
 unsigned char temp; 
/*[bit6]
 0=Complete
...
*/ 
 ...
 1= Arbitration lost
*/
unsigned char R5421_I2CM_Arbitration(void)
{
 unsigned char temp; 
/*[bit6]
I2C Bus is Busy
